...
Shader "Hidden/DeferredReflectionsSettingShader" {
Properties {
    _SrcBlend ("", Float) = 1
    _DstBlend ("", Float) = 1
}
...
half4 frag (unity_v2f_deferred i) : SV_Target
{
    ...
    half distanceSq = dot(distance, distance);
    half blendDistanceSq = blendDistance * blendDistance;
    half falloff = saturate(1.0 - distanceSq / blendDistanceSq);
